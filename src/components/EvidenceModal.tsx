      ...
      <DialogContent className='max-w-5xl max-h-[95vh] overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-black border-gray-700/50 shadow-2xl'>
        ...
        <div
          className={`bg-gradient-to-r ${getTypeColor(
            evidence.news_type
          )} p-6 -m-6 mb-6 relative overflow-hidden`}
        >
          ...
          <div className='relative z-10'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <h2 className='text-2xl font-bold text-white text-right mb-1'>
                    {evidence.title}
                  </h2>
                  <div className='flex items-center gap-2 text-white/80'>
                    <Badge
                      className={`text-xs border ${getExceptionColor(
                        evidence.exception_level
                      )} animate-pulse`}
                    >
              ...
              <div className='flex items-center gap-2'>
                <Button
                  variant={
                    isEvidenceSelected(evidence.id) ? 'default' : 'outline'
                  }
                  size='sm'
              ...
              <div className='bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-xl p-4 border border-gray-700/30 backdrop-blur-sm'>
                <div className='relative'>
                  ...
                  <div className='absolute inset-0 bg-black/40 rounded-lg flex items-center justify-center group-hover:bg-black/60 transition-colors'>
                    <Button
                      size='lg'
                      className='gap-3 bg-white/10 hover:bg-white/20 border border-white/20 text-white backdrop-blur-sm'
                    >
