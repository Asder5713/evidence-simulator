...
export const evidence: Evidence[] = [
  ...
  },
  {
    ...
    content:
      'החל מעקב סמוי אחר יוסי כהן ושותפיו. זוהו 3 נקודות מפגש קבועות והרגלי תנועה.',
  ...
  },
  {
    ...
    content:
      'זוהה תנועה חשודה ברחוב הנביאים 12. שני רכבים עם לוחיות מזויפות. יש להכין כוחות מיוחדים.',
  ...
  },
  {
    ...
    content:
      'מצאנו את גופתו של דני לוי במחסן. זירת רצח ברורה. סימני עינויים. צריך לחסום את כל היציאות מהעיר.',
    comments: 'גילוי הרצח',
    exception_level: 5,
  },
