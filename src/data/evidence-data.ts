...
export const evidence: Evidence[] = [
  ...
  },
  {
    ...
    formation: 'מערכת אימייל',
    content:
      'מיקי,\n\nהמשלוח מקולומביה יגיע ביום רביעי לנמל אשדוד.\nדאג שהאנשים יהיו מוכנים ב-03:00 בבוקר.\n\nקונטיינר מספר: MSKU-4829671\n\nתיזהר עם המכס, יש לי חשד שהם עלו עלינו. גם דאג לחומר נפץ למקרה שנצטרך לנפץ דברים.\n\nס.',
    comments: 'ראיה לפעילות סחר בסמים ותכנון מבצע עם חבלה',
    exception_level: 4,
  },
  {
    id: 'email-003',
  ...
  // הודעות טקסטואליות
  {
    ...
    content:
      'נפתח תיק חקירה נגד יוסי כהן בעקבות תלונות על הפעלת לחץ ואיומים על בעלי עסקים באזור. החשוד מוגדר כמטרה למעקב ביטחוני.',
    comments: 'פתיחת החקירה הרשמית - מטרה ביטחונית',
    exception_level: 3,
  },
  {
    id: 'text-00grte1',
    ...
    formation: 'מחלקת חקירות',
    content:
      'נפתח תיק חקירה נגד יוסי כהן בעקבות תלונות על הפעלת לחץ ואיומים על בעלי עסקים באזור.',
  ...
  },
  {
    ...
    content:
      'החל מעקב סמוי אחר יוסי כהן ושותפיו. זוהו 3 נקודות מפגש קבועות והרגלי תנועה. נאסף מודיעין על הרגלי החשוד והמטרות שלו.',
    comments: 'תחילת מעקב מבצעי - איסוף מודיעין על מטרה',
    exception_level: 3,
  },
  {
    id: 'text-003',
    ...
    content:
      'התקבלה תלונה נוספת מדני לוי על החמרה באיומים. המתלונן דיווח על מעקב חשוד אחריו.',
  ...
  },
  {
    ...
    content:
      'זוהה תנועה חשודה ברחוב הנביאים 12. שני רכבים עם לוחיות מזויפות. יש להכין כוחות מיוחדים למבצע. נראה שיש איום ביטחוני ממשי.',
    comments: 'זיהוי פעילות חשודה - הכנה למבצע ביטחוני',
    exception_level: 5,
  },
  {
    id: 'text-0005',
    ...
    formation: 'מוקד 100',
    content:
      'דיווח על ירי באזור הנמל. מספר רב של כוחות נדרש למקום. אמבולנס בדרך.',
  ...
  },
  {
    ...
    content:
      'מצאנו את גופתו של דני לוי במחסן. זירת רצח ברורה. סימני עינויים. צריך לחסום את כל היציאות מהעיר. מתכוננים למבצע מעצר של הטרוריסט.',
    comments: 'גילוי הרצח - מעבר למבצע נגד המחבל',
    exception_level: 5,
  },
  ...
  // ראיות ויזואליות
  {
    ...
    content: 'תמונת זיהוי ראשונית של החשוד המרכזי בדרך בן גוריון, תל-אביב. המטרה תחת מעקב מתמשך',
    comments: 'זיהוי החשוד במקום ציבורי - מטרה למעקב',
    exception_level: 3,
    file_url:
  ...
  },
  {
    ...
    content: 'הקלטת שיחת תכנון בין יוסי כהן לשותף לא מזוהה. דובר על נשק ומבצע נגד מטרות אזרחיות',
    comments: 'ראיה לתכנון פעילות טרור עם נשק נגד מטרות',
    exception_level: 4,
    file_duration: '04:22',
  },
  {
